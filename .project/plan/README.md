...
Fakturus Track ist eine Zeiterfassungsloesung fuer den deutschen Markt. Wir entwickeln native iOS- und Android-Apps, um eine erstklassige Nutzererfahrung zu bieten.
...
Wir entwickeln **native Apps** (nicht Cross-Platform) aus folgenden Gruenden:
...
| Offline | SQLite + strukturierte Sync-Logik |
...
| Phase 4 | Q4 2026 (4 Wochen) | Store-Launch + Feature-Gating |
...
|--------|--------------------|-----------|
| Offline-Sync Komplexitaet | Hoch | Bewaehrte Sync-Logik als Referenz |
